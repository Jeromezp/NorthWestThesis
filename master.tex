\documentclass[a4paper,twoside,linespread=1.5,zihao=-4]{ctexrep}
...
\ctexset{
	...
	subsection/format += \raggedright \zihao{-4} \songti \textbf,
...
\renewcommand{\captionfont}{\small \heiti} 
